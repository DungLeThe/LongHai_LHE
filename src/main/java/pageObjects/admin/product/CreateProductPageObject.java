...
public class CreateProductPageObject extends BasePage {
	...
	public boolean isAddNewProductTextDisplayed() {
		waitForElementVisible(driver, AdminHomePageUI.ADD_NEW_PRODUCT_TEXT);
		return isElementDisplay(driver, AdminHomePageUI.ADD_NEW_PRODUCT_TEXT);
	}
