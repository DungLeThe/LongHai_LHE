...
public class AdminHomePageUI {
	...
	public static final String DATE_OF_BIRTH_MARKETING_STAFF_INPUT = "//p[text()='Ngày sinh ']/parent::div/div//input";
	public static final String NAME_MARKETING_STAFF_INPUT = "//input[@placeholder='Nhập họ và tên']";
	public static final String GENDER_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn Giới tính']";
	public static final String MARITAL_STATUS_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn TTHN']";
	public static final String PHONE_NUMBER_MARKETING_STAFF_INPUT = "//input[@placeholder='Nhập số điện thoại']";
	public static final String DATE_RANGE_MARKETING_STAFF_INPUT = "//p[text()='Ngày cấp ']/parent::div/div//input";
	public static final String ISSUED_BY_MARKETING_STAFF_INPUT = "//input[@placeholder='Nhập nơi cấp']";
	public static final String ADDRESS_MARKETING_STAFF_INPUT = "//input[@placeholder='Nhập địa chỉ']";
	public static final String POSITION_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn chức vụ']";
	public static final String NATIONALITY_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn quốc tịch']";
	public static final String NATION_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn dân tộc']";
	public static final String REGION_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn vùng']";
	public static final String AREA_MARKETING_STAFF_INPUT = "//input[@placeholder='Chọn khu vực']";
	public static final String TIME_IN_MARKETING_STAFF_INPUT = "//p[text()='Thời gian vào ']/parent::div/div//input";
	public static final String NEXT_MARKETING_STAFF_BUTTON = "//div[@class='create-user-page__action bg-white f aic jcb px1 gap1 box-shadow-t'][2]//span[text()='Tiếp theo']";
	public static final String ERROR_MESSAGE_EMPTY_MARKETING_STAFF_NAME = "//p[text()='Họ và tên ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_PHONE = "//p[text()='Số điện thoại ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_DATE_OF_BIRTH = "//p[text()='Ngày sinh ']/parent::div/div//p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_ID_CARD = "//p[text()='CMT/CCCD ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_DATE_RANGE = "//p[text()='Ngày cấp ']/parent::div/div//p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_ISSUE_BY = "//p[text()='Nơi cấp ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_SELECT_ADDRESS = "//p[text()='Địa chỉ ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_GENDER = "//p[text()='Giới tính ']/parent::div/div/p";
	public static final String ERROR_MESSAGE_MARKETING_STAFF_EMPTY_MARITAL_STATUS = "//p[text()='Tình trạng hôn nhân ']/parent::div/div/p";
	public static final String VALUE_GENDER_MARKETING_STAFF_INPUT = "//ul[@id='vs3__listbox']/li[1]";
	public static final String VALUE_MARITAL_STATUS_MARKETING_STAFF_INPUT = "//ul[@id='vs4__listbox']/li[1]";
	public static final String VALUE_POSITION_MARKETING_STAFF_INPUT = "//ul[@id='vs5__listbox']/li[1]";
	public static final String VALUE_NATIONALITY_MARKETING_STAFF_INPUT = "//ul[@id='vs8__listbox']/li[1]";
	public static final String VALUE_NATION_MARKETING_STAFF_INPUT = "//ul[@id='vs9__listbox']/li[1]";
	public static final String VALUE_REGION_MARKETING_STAFF_INPUT = "//ul[@id='vs6__listbox']/li[1]";
	public static final String VALUE_AREA_MARKETING_STAFF_INPUT = "//ul[@id='vs7__listbox']/li[1]";
	public static final String ACCOUNT_MARKETING_STAFF_TEXT = "//div[contains(text(),'Tài khoản nhân viên thị trường')]";
	public static final String ACCOUNT_MARKETING_STAFF_INPUT_TEXT = "//input[@placeholder='VD: Số điện thoại của bạn']";
	public static final String PASSWORD_MARKETING_STAFF_INPUT_TEXT = "//input[@placeholder='Nhập mật khẩu']";
	public static final String EMAIL_MARKETING_STAFF_INPUT_TEXT = "//input[@placeholder='Nhập email']";
	public static final String CREATE_MARKETING_STAFF_BUTTON = "//div[@class='create-user-page__container px1']/div/div[4]//span[text()='Tạo mới']";
